<template>
  <div class="info_protection">
    <div class="breadcrumb">
      <Breadcrumb link="dashboard" text1="Home" text2="Evidence management" text3="Evidence List" />
    </div>
    <div class="heading flex justify-between align-end">
      <h4>View the Details of the Evidence</h4>
    ...
    <div class="managmenttable">
        <div class="delete_wrap">
            <p>* in the evidence list Applicable evidence delete.</p>
        </div>
            <DataTable
    ...
    <div class="explenation">
        <div class="details">
            ...
            <div class="right">
            <p>Exposure of explanatory text Scroll exposure when out of the relevant area</p>
            </div>
        </div>
        <div class="details">
    ...
    <div class="button_wrap fixed-button-wrap flex justify-between">
      <div class="buttons flex justify-start">
        <button type="button" class="gray">Evidence Choose A Form</button>
        <button type="button" class="gray">Evidence File Upload</button>
      </div>
      <div class="buttons flex justify-center">
        <button type="button" class="gray">Approval</button>
      </div>
  ...
  data() {
    return {
      ...
      colData: [
        ...
        {
          name: "Evidence Number of People",
          id: "writer_name",
          isSortable: false,
          type: "text",
        },
