<template>
  <div class="info_protection UserAdmin">
    ...
    <div class="heading flex justify-between align-end">
      <h4 class="border-bottom">사용자 정보 변경</h4>
    </div>
    <div>
      <form class="form_wrap">
        ...
        <div class="grid grid-rows-1 grid-cols-2 grid-gap">
          ...
          <div class="input-field">
            ...
            <div
              class="input-group"
              :class="error.authority ? 'field-error' : ''"
            >
              <select
        ...
        <div class="grid grid-rows-1 grid-cols-1 grid-gap">
          <div class="account-setting">
            ...
            <div class="grid grid-rows-1 grid-cols-2 grid-gap">
              ...
              <div class="settings-group">
                <p>비밀번호 만료일: {{ password_expiration_Date }}</p>
                <button
                  type="button"
                  class="primary-btn btn-grey-outline"
        ...
        <!-- <div class="grid grid-rows-1 grid-cols-1 grid-gap">
          <div class="input-field">
            <p>
              If approval is rejected, please write the reason for rejection
            </p>
            <textarea
              class="form-control"
              rows="7"
  ...
  methods: {
      ...
      this.userAdmin
        ...
        .then((res) => {
          if (res.status == 200) {
            ...
            this.IP_Access_Radio = res.data.ip_access_type;
            ...
            this.Evidence_type = res.data.allowed_evidence_group_type;
            this.asset_type = res.data.allowed_asset_group_type;
    ...
    checkMember(check_approval_status) {
      ...
      if (check_approval_status == "rejected") {
        if (this.note == "") {
          this.error.note = "Please write the reason for rejection";
        } else {
