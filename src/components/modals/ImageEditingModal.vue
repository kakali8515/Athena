    ...
    <div class="modal-overlap waitingcompanyapproval">
        <div class="modal-dialog modal-dialog-centered relative w-auto pointer-events-none">
            ...
            <div class="modal-header flex flex-shrink-0 items-center justify-between p-4 rounded-t-md">
                ...
                data-bs-dismiss="modal" aria-label="Close" @click="this.$emit('closeImageEditingModal')"></button>
            </div>
                    ...
                    <div class="document_pssword">
                        ...
                        <div class="file_upload_wrap">
                            <div class="input_wrap">
                                <input type="text" placeholder="파일명 .확장자" readonly v-model="fileName">
                                <div class="file_wrap">
            ...
            <div
                ...
                <button type="button"
                @click="this.$emit('closeImageEditingModal')"
...
export default {
  ...
  props: {
    selectedId: Number,
    networkDiagramList: Object,
  },
  
  data() {
    return {
      diagram_name: this.networkDiagramList.diagram_name, 
      file: this.networkDiagramList.diagram.split('/').pop(),
      fileName:  this.networkDiagramList.diagram.split('/').pop(),
      fileSize: "",
      errorMsg: "",
      error: {},
  ...
  methods: {
    ...
    async uploadImage() {
      if (!this.checkError()) {
        ...
        this.formData.append("diagram_name",this.diagram_name);
        // formData.append("diagram", this.file);
        this.formData.append("certification", this.$store.state.header.certificate);
        this.formData.append("network_diagram_id", this.networkDiagramList.id);
        const res = await this.NetworkDiagramService.uploadImage(this.formData)
        if(res) {
          this.$emit('closeImageEditingModal')
    ...
    onFileChange(e) {
      ...
      this.formData.append("diagram", this.file);
